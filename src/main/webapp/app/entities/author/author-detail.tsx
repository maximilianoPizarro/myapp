  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="myappApp.author.detail.title">Author</Translate> [<b>{authorEntity.id}</b>]
          </h2>
