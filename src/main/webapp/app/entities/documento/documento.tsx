...
import { getSearchEntities, getEntities } from './documento.reducer';
...
export class Documento extends React.Component<IDocumentoProps, IDocumentoState> {
  state: IDocumentoState = {
    search: ''
  };
    ...
    return (
      <div>
        <h2 id="documento-heading">
          <Translate contentKey="myappApp.documento.home.title">Documentos</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="myappApp.documento.home.createLabel">Create new Documento</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('myappApp.documento.home.search')}
                  />
